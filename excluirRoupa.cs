...
{
    public partial class excluirRoupa : Form
    {
        public int ID;
        public excluirRoupa(int code)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string excluir = "DELETE FROM `cadastro` WHERE id = "+ID;

            MySqlCommand comandos = new MySqlCommand(excluir, conectar);
